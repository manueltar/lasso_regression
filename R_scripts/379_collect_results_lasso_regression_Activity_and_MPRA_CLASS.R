...
collect_Activity = function(option_list)
{
  opt_in = option_list
  opt <<- option_list
  ...
  indexes_sel <- grep("Lasso_regression_Activity",file_list)
  ...
  file_list_sel$Cell_Type[which(file_list_sel$Cell_Type == 'At')]<-'At_least_one_cell_type'
  ...
  Results$Cell_Type<-factor(Results$Cell_Type,
                            levels=c('At_least_one_cell_type','K562','CHRF','HL60','THP1'),
                            ordered=T)
  ...
  write.table(Results, 
              file=paste("collected_results_Activity",".tsv",sep=""), 
              row.names = F, quote=F, sep="\t")
  
  saveRDS(Results, 
          file=paste("collected_results_Activity",".rds",sep=""))
  
  
}

collect_MPRA_CLASS = function(option_list)
{
  opt_in = option_list
  opt <<- option_list
  ...
  indexes_sel <- grep("Lasso_regression_MPRA_CLASS",file_list)
  ...
  write.table(Results, 
              file=paste("collected_results_MPRA_CLASS",".tsv",sep=""), 
              row.names = F, quote=F, sep="\t")
  
  saveRDS(Results, 
          file=paste("collected_results_MPRA_CLASS",".rds",sep=""))
  
  
}

collect_log2FC_meta = function(option_list)
{
  opt_in = option_list
  opt <<- option_list
  ...
  indexes_sel <- grep("Lasso_regression_log2FC_meta",file_list)
  ...
  write.table(Results, 
              file=paste("collected_results_log2FC_meta",".tsv",sep=""), 
              row.names = F, quote=F, sep="\t")
  
  saveRDS(Results, 
          file=paste("collected_results_log2FC_meta",".rds",sep=""))
  
  
}

collect_abs_log2Skew_meta = function(option_list)
{
  opt_in = option_list
  opt <<- option_list
  ...
  indexes_sel <- grep("Lasso_regression_abs_log2Skew_meta",file_list)
  ...
  write.table(Results, 
              file=paste("collected_results_abs_log2Skew_meta",".tsv",sep=""), 
              row.names = F, quote=F, sep="\t")
  
  saveRDS(Results, 
          file=paste("collected_results_abs_log2Skew_meta",".rds",sep=""))
...
main = function() {
  ...
  collect_Activity(opt)
  collect_MPRA_CLASS(opt)
  collect_log2FC_meta(opt)
  collect_abs_log2Skew_meta(opt)
